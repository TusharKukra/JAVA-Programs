...
// here we are using BufferReader Class for taking input from the user
import java.io.*;

public class JDBCProgram3InsertFromUser {
	...
	public static void main(String[] args) {
		...
		try {
	         ...
	         // setting the values to query (here don't pass the tName tCity directly, use BufferReader to take input from the user)
	         ...
	         ps.setString(1,name);  // this is the tName (setString, bcoz the tName is of String type)
	         ps.setString(2, city);  // this is tCity
